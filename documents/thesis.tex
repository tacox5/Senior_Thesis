...
\tocless\section{\hypertarget{sec:methods}{2.\hspace{0.75em}Modeling the Intergalactic Medium}}
\addcontentsline{toc}{section}{2.\hspace{0.75em}Modeling the Intergalactic Medium}
...
\addcontentsline{toc}{section}{3.\hspace{0.75em}Cross-Correlation Studies}
	...
	\addcontentsline{toc}{subsection}{3.3.\hspace{0.75em}Foreground Contamination}
		...
		\input{sections/methods/wedge.tex}
