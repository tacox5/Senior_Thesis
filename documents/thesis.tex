...
\addcontentsline{toc}{section}{1.\hspace{0.75em}Introduction}
	...
	\tocless\subsection{\hypertarget{subsec:hera}{1.2.\hspace{0.75em}The Hydrogen Epoch of Reionization Array}}
	\addcontentsline{toc}{subsection}{1.2.\hspace{0.75em}The Hydrogen Epoch of Reionization Array}

		\input{sections/intro/hera}


	\tocless\subsection{\hypertarget{subsec:spherex}{1.2.\hspace{0.75em}SPHEREx}}
